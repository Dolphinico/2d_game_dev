...
# Чтобы игра сбрасывалась при каждом нажатии кнопки Play, сбрасываем
# игровую статистику, стираем старых пришельцев и пули, строим новый флот
# возвращаем корабль в центр нижней стороны:
...
def check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """Проверяет добрались пришельцы до конца экрана или нет"""
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    # Затем программа передает sb функциям ship_hit() и check_aliens_bottom(), чтобы эти
